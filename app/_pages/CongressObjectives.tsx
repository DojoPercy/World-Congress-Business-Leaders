...
import { FaNetworkWired, FaAward, FaLightbulb } from "react-icons/fa";
import "swiper/css";
...
const CongressObjectives = () => {
  const info = [
    ...
    },
    {
      title: "Networking",
      description:
        "To facilitate connections and collaborations among business leaders, innovators, and decision-makers.",
      icon: FaNetworkWired,
    },
    {
      title: "Recognition",
      description:
        "To celebrate and recognize outstanding achievements and contributions to the global business community.",
      icon: FaAward,
    },
    {
      title: "Inspiration",
      description:
        "To inspire the next generation of leaders with success stories, innovative ideas, and visionary strategies.",
      icon: FaLightbulb,
    },
  ];
              ...
              <SwiperSlide key={index} className="lg:px-4 max-h-[25rem]">
                <div className="flex justify-center w-full  border border-grayColor rounded-lg p-10">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <span className="font-[400] text-[14px] pt-5 text-center">
                      {item.description}
                    </span>
                  </div>
                </div>
